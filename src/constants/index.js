...
export const HERO_CONTENT = `I am a passionate UG CSE student who is learning web development and actively working on mini projects. I have honed my skills in front-end technologies like React and Next.js, as well as back-end technologies like Node.js, MySQL, and MongoDB. My goal is to leverage my growing expertise to create innovative solutions that drive business growth and deliver exceptional user experiences`;

export const ABOUT_TEXT = `I am a dedicated and versatile computer science engineering student with a strong foundation in web development. Currently pursuing my degree at PERI Institute of Technology, I have honed my skills through hands-on experience with technologies such as React, Next.js, Node.js, MySQL, and MongoDB. My academic journey is complemented by participation in hackathons and a Java programming internship, where I developed practical skills in Python, Java, C, and front-end technologies. Known for my sincerity and hard work, I continuously seek to learn and adapt to new challenges. Outside of my studies, I enjoy PC gaming and staying updated with industry trends. Open to opportunities to make a positive impact in computer science.`;
